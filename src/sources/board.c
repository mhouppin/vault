...
void boardstack_init(Boardstack *restrict stack, const Board *restrict board) {
    ...
    stack->feature_add[0] = stack->feature_add[1] = 0;
    stack->feature_sub[0] = stack->feature_sub[1] = 0;
...
void board_do_move_gc(
    ...
    new_stack->feature_sub[0] = feature_index(piece, from);
    new_stack->feature_sub[1] = 0;
    new_stack->feature_add[1] = 0;
    ...
    if (move_type(move) == CASTLING) {
        ...
        new_stack->feature_sub[1] = feature_index(captured_piece, rook_from);
        new_stack->feature_add[1] = feature_index(captured_piece, rook_to);
    ...
    if (captured_piece) {
        ...
        new_stack->feature_sub[1] = feature_index(captured_piece, capture_square);
    ...
    if (piece_type(piece) == PAWN) {
        ...
        if ((to ^ from) == 16
            ...
            new_stack->feature_add[0] = feature_index(new_piece, to);
        }
    ...
    if (move_type(move) != PROMOTION) {
        new_stack->feature_add[0] = feature_index(piece, to);
    }
...
void board_do_null_move(Board *restrict board, Boardstack *restrict new_stack) {
    ...
    new_stack->feature_sub[0] = new_stack->feature_sub[1] = 0;
    new_stack->feature_add[0] = new_stack->feature_add[1] = 0;
